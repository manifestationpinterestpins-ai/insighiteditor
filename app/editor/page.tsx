      ...
      >
        <CloseIcon />
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <button onClick={() => { setSummaryLoading(true); setViewsAnimKey(k => k + 1); setTimeout(() => setSummaryLoading(false), 800); setAnimateBanner(false); setTimeout(() => setAnimateBanner(true), 500) }} className="focus:outline-none active:opacity-60 transition-opacity"><InfoIcon /></button>
                    </div>
