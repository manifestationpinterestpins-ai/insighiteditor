...
const SendIcon = () => (
  <svg width="18" height="18" viewBox="0 0 512 512" fill="none">
    <path fill="white" d="M448.94 59.75c9.6 9.26 15.48 21.68 16.06 35.01 0 11.57-3.62 22.58-6.93 33.53-.5.7-1.01 2.4-1.51 4.1-.5 1.7-1 3.4-1.51 5.1-1.08 3.65-2.17 7.29-3.26 10.94-1.75 5.85-3.49 11.7-5.23 17.55-.6 2.02-1.2 4.04-1.8 6.06-.45 1.52-1.35 4.55-1.8 6.06-.92 3.11-1.85 6.22-2.77 9.33-5.87 19.7-11.66 39.42-17.44 59.15-2.52 8.61-5.05 17.22-7.57 25.83-.84 2.86-1.68 5.72-2.52 8.58-8.59 29.29-17.2 58.57-25.82 87.85-2.46 8.37-4.92 16.74-7.38 25.11-1.7 5.78-3.4 11.56-5.1 17.34-.67 2.28-1.34 4.55-2 6.83-.9 3.05-1.8 6.1-2.7 9.15-.25.86-.5 1.72-.75 2.58-4.2 14.12-9.97 25.42-22.26 34.19-13.22 7.14-26.61 9.24-41.48 6.32-2.66-.92-5.05-1.98-7.52-3.31-.86-.44-1.72-.88-2.6-1.33-8.74-4.82-14.53-10.68-19.36-19.41-.38-.69-.77-1.38-1.15-2.07-5.83-10.61-11.2-21.45-16.62-32.25"/>
  </svg>
)
