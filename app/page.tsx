...
export default function ReelInsights() {
  ...
  className="flex items-center justify-center gap-7 mt-4 px-3 overflow-visible [&_svg]:block [&_svg]:overflow-visible"
  style={{
    ...
    width: tabsSticky ? "75%" : "100%",
    maxWidth: tabsSticky ? 315 : undefined,
    backgroundColor: tabsSticky ? BG : "transparent",
    zIndex: tabsSticky ? 45 : undefined,
    paddingTop: tabsSticky ? 8 : undefined,
    paddingBottom: tabsSticky ? 8 : undefined,
  }}
>
  ...
  <div className="flex flex-col items-center gap-1 min-w-[38px]" style={{ lineHeight: 0 }}>
    ...
    <span className="text-[12px] text-white leading-none font-bold">{insightsData.bookmarks}</span>
                              ...
                              {/* Tabs placeholder */}
<div style={{ height: tabsSticky ? 90 : 0 }} />
